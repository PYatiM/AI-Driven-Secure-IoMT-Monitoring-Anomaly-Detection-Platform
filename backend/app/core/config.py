...
class Settings(BaseSettings):
    ...
    telemetry_batch_max_records: int = Field(default=1000, ge=1, le=10000)
    telemetry_queue_enabled: bool = Field(default=True)
    telemetry_queue_batch_size: int = Field(default=250, ge=1, le=5000)
    telemetry_queue_flush_interval_ms: int = Field(default=1000, ge=50, le=10000)
